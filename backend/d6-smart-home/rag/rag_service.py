...
KNOWLEDGE = [
    ...
    # 房间
    {"id": "room_living", "text": "客厅 客厅灯 客厅空调 客厅风扇 客厅温度 living room", "cat": "room", "meta": {"room": "客厅", "devices": ["light_01", "ac_01", "door_01", "alarm_01", "camera_01"], "sensors": ["temp_01", "humid_01"]}},
